...
LOGO_URL = "/assets/exos_claims_ai/images/exos-logo-full.png"
MARK_URL = "/assets/exos_claims_ai/images/exos-mark.png"
...
def apply_branding() -> None:
    ...
    frappe.db.set_single_value("Website Settings", "favicon", MARK_URL)
    frappe.db.set_single_value("Website Settings", "app_name", "EXOS Claims")
    frappe.db.set_single_value("Website Settings", "brand_html", "EXOS")
